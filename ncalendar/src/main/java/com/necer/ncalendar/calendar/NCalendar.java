...
public class NCalendar extends FrameLayout implements NestedScrollingParent, ValueAnimator.AnimatorUpdateListener, OnWeekCalendarChangedListener, OnMonthCalendarChangedListener {
    ...
    private boolean weektype = false;
    private int weekpos;
    ...
    public NCalendar(final Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void onWeekCalendarChanged(DateTime dateTime) {
        if (STATE == WEEK) {
            ...
            Log.d("week-->",dateTime.getMonthOfYear()+","+dateTime.getDayOfMonth()+","+dateTime.getDayOfWeek());
            requestLayout();
    ...
    public void onMonthCalendarChanged(DateTime dateTime) {
        ...
        Log.d("month-->",dateTime.getMonthOfYear()+","+dateTime.getDayOfMonth()+","+dateTime.getDayOfWeek());
        if (STATE == MONTH) {
