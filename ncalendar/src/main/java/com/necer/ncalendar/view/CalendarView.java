...
public abstract class CalendarView extends View {
    ...
    protected int mSelectTextColor;//选中的字体颜色
    protected int mSelectdianleColor;//选中的提示点颜色
    ...
    public CalendarView(Context context) {
        ...
        mSelectdianleColor = Attrs.selectdianColor;
        ...
        mSelectPaint = getPaint(mSelectTextColor, mSelectdianleColor);
