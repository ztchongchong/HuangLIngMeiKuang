...
public class ClipViewLayout extends RelativeLayout {
    ...
    public Bitmap clip() {
        ...
        try {
            Log.e("ClipViewLayout", " rect.left =" + rect.left + " , rect.top=" + rect.top + " ,rect.width()=" + rect.width() + " , rect.height()=" + rect.height());
            cropBitmap = Bitmap.createBitmap(imageView.getDrawingCache(), rect.left, rect.top, rect.width(), rect.height());
            //zoomedCropBitmap = zoomBitmap(cropBitmap, 400, 300);
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (cropBitmap != null) {
