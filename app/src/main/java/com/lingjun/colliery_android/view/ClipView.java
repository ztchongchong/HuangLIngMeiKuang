...
//            //绘制中间的矩形
//            canvas.drawRect(0, this.getHeight() / 2 - clipWidth / 2,
//                    this.getWidth(), this.getHeight() / 2 + clipWidth / 2, paint);
//            Log.e("ClipView", " rect.left =" + mHorizontalPadding + " , rect.top=" + (this.getHeight() / 2 - clipWidth / 2) + " ,rect.width()=" + (this.getWidth()) + " , rect.height()=" + (this.getHeight() / 2 + clipWidth / 2));
//            //绘制白色的矩形边框
//            canvas.drawRect(0, this.getHeight() / 2 - clipWidth / 2,
//                    this.getWidth(), this.getHeight() / 2 + clipWidth / 2, borderPaint);
//            Log.e("ClipView", " rect.left =" + mHorizontalPadding + " , rect.top=" + (this.getHeight() / 2 - clipWidth / 2) + " ,rect.width()=" + this.getWidth() + " , rect.height()=" + (this.getHeight() / 2 + clipWidth / 2));
        }
