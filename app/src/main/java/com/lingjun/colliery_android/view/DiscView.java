...
import com.lingjun.colliery_android.utils.DiscViewUtils;
import com.lingjun.colliery_android.view.tablayout.CircleView;
...
public class DiscView extends FrameLayout {
     ...
     * @param value
     */
    public void setValue(double value, int duration) {
        if (animator.isRunning()) {//上次动画未结束
            animator.cancel();//取消上次动画
            mCircleView.clearAnimation();
        }

        animator = ValueAnimator.ofInt(0, (int) (value/10));
