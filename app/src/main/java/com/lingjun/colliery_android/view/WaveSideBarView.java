...
public class WaveSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mLetters = Arrays.asList(context.getResources().getStringArray(com.vondear.rxui.R.array.waveSideBarLetters));
        ...
        mTextSize = context.getResources().getDimensionPixelSize(com.vondear.rxui.R.dimen.textSize_sidebar);
        mLargeTextSize = context.getResources().getDimensionPixelSize(com.vondear.rxui.R.dimen.large_textSize_sidebar);
        mPadding = context.getResources().getDimensionPixelSize(com.vondear.rxui.R.dimen.textSize_sidebar_padding);
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, com.vondear.rxui.R.styleable.WaveSideBarView);
            mTextColor = a.getColor(com.vondear.rxui.R.styleable.WaveSideBarView_sidebarTextColor, mTextColor);
            mTextColorChoose = a.getColor(com.vondear.rxui.R.styleable.WaveSideBarView_sidebarChooseTextColor, mTextColorChoose);
            mTextSize = a.getFloat(com.vondear.rxui.R.styleable.WaveSideBarView_sidebarTextSize, mTextSize);
            mLargeTextSize = a.getFloat(com.vondear.rxui.R.styleable.WaveSideBarView_sidebarLargeTextSize, mLargeTextSize);
            mWaveColor = a.getColor(com.vondear.rxui.R.styleable.WaveSideBarView_sidebarBackgroundColor, mWaveColor);
            mRadius = a.getInt(com.vondear.rxui.R.styleable.WaveSideBarView_sidebarRadius, context.getResources().getDimensionPixelSize(com.vondear.rxui.R.dimen.radius_sidebar));
            mBallRadius = a.getInt(com.vondear.rxui.R.styleable.WaveSideBarView_sidebarBallRadius, context.getResources().getDimensionPixelSize(com.vondear.rxui.R.dimen.ball_radius_sidebar));
            a.recycle();
        }
