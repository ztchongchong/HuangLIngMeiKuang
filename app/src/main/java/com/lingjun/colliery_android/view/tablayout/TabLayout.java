...
//                int with = ((mIndicatorRight - mIndicatorLeft) - dpToPx(25)) / 2 > 0
//                        ? ((mIndicatorRight - mIndicatorLeft) - dpToPx(25)) / 2 : 0;
                Paint paint = new Paint();
                paint.setTextSize(mTabTextSize);
                int with = ((mIndicatorRight - mIndicatorLeft) - paint.measureText("长")) / 2 > 0
                        ? (int) (((mIndicatorRight - mIndicatorLeft) - paint.measureText("长")) / 2) : 0;
                canvas.drawRect(mIndicatorLeft + with, getHeight() - mSelectedIndicatorHeight,
                        mIndicatorRight - with, getHeight(), mSelectedIndicatorPaint);
            }
        }
    }
