...
public class SpecialPersonnelFragment extends BaseFragment {

    private RecyclerView rv_list;

    @Override
    protected int setLayout(LayoutInflater inflater) {
        return R.layout.fragment_special_personnel;
    }
    ...
    private void refreshView() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            taskBean.num = i;
            taskBean.name = "特邀: 张三,李四";
            mList.add(taskBean);
        }

        RecyclerViewUtils.initLinerNoSc(getActivity(), rv_list, R.layout.item_special_personnel_entry, mList, new OnGlobalListener() {
            @Override
