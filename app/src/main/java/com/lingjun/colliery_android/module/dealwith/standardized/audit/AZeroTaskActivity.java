...
import com.lingjun.colliery_android.module.dealwith.standardized.fragment.AZeroTaskFragment;
...
public class AZeroTaskActivity extends BaseActivity {
...
//    private static final String[] tabTitle = {"1部分", "2部分", "3部分", "4部分", "5部分"};
    ...
    protected int getResourcesId() {
        return R.layout.activity_azero_task;
    }
...
//            mList.add(new AZeroTaskFragment());
//        }
//
...
//        @Override
//        public CharSequence getPageTitle(int position) {
//            return AZeroTaskActivity.tabTitle[position];
//        }
//    }
}
