...
public class FullMarksTaskFragment extends BaseFragment {

    private RecyclerView rv_list;

    @Override
    protected int setLayout(LayoutInflater inflater) {
        return R.layout.fragment_fullmarks_task;
    }
    ...
    private void refreshView() {
        ...
        RecyclerViewUtils.initLinerNoSc(getActivity(), rv_list, R.layout.item_full_marks_task_entry, mList, new OnGlobalListener() {
            @Override
