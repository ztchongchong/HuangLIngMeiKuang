...
import com.lingjun.colliery_android.module.dealwith.fragment.NeedCheckTaskFragment;
...
public class NeedCheckTaskActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        for (int i = 0; i < titlelist.size(); i++) {
            NeedCheckTaskFragment taskFragment = NeedCheckTaskFragment.newInstance(titlelist.get(i), i);
