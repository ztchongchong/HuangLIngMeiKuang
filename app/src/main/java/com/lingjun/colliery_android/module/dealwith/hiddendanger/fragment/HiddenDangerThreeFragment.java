 ...
 * 显示督办
 */
public class HiddenDangerThreeFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static HiddenDangerThreeFragment newInstance(InputAcceptInfoBean cooperativeSwitchBean) {
//        Bundle args = new Bundle();
//        HiddenDangerThreeFragment fragment = new HiddenDangerThreeFragment();
...
//        deduction = getIntent.getStringExtra("deduction");//获取的扣分
//        fine = getIntent.getStringExtra("fine");//获取的罚款数
...
////        }
    ...
    private void submission() {
        ...
        hashMap.put("troubleLevelId", "" + troubleLevelId);//隐患等级number
        ...
        hashMap.put("troubleType", "3");//troubleType判断1现场治理，2限时整改,3挂牌督办,4隐患升级
        ...
        hashMap.put("acceptanceId", "0");//验收人员ID
...
//        hashMap.put("solutionGoal", "" + et_content.getText().toString().trim());//验收依据(手动输入)
        ...
        hashMap.put("responsibleLeaderId", responsibleLeaderId);//验收人员ID
        hashMap.put("responsibleLeaderinfo", responsibleLeaderinfo);//验收人员ID
        hashMap.put("classTime", classTime);//班次名称
        if (null != time) {
        ...
        if (hiddentype.equals("1")) {
            ...
            mRetrofit.JsonToColliery(BaseLinkList.Base_Url, hashMap, new BaseSubscriber() {
                ...
                public void onSuccess(JSONObject jsonObject) throws JSONException {
                    dismissDialog();
                    LogUtils.e("挂盘督办->>" + jsonObject.toString());
        ...
        switch (resultCode) {
            case ResponsibilityActivity.RectifyingCode:
                ...
                if (data != null) {
                    ...
                    processor_id = data.getStringExtra("processor_id");//处理人ID
            ...
            case AcceptorActivity.HiddenDangerCode:
                ...
                break;
            case SuperiorLeaderActivity.RectifyingCode:
                //带回数据
                if (data != null) {
