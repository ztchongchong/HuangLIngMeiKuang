 ...
 * 注释:三违销号
 */
public class CorrectingSalesNumbersFragment extends BaseFragment {
    ...
    protected int setLayout(LayoutInflater inflater) {
        return R.layout.fragment_correctingsalesnumbers;
    }
    ...
    protected BaseRefreshLoadMoreInterface setRefreshLoadMoreListener() {
        if (jurisdiction.contains("DISOBEY_CLOSE")) {
            Log.e("三违销号", jurisdiction.contains("DISOBEY_CLOSE") + "");
    ...
    private void refreshView() {
        ...
        mRetrofit.JsonToColliery(BaseLinkList.Base_Url, hashMap, new BaseSubscriber() {
            ...
            public void onSuccess(JSONObject jsonObject) {
                LogUtils.e("三违销号列表->>" + jsonObject.toString());
...
//                                    String url = "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1540203338&di=9247014afd935d47a128122e8c73c549&imgtype=jpg&er=1&src=http%3A%2F%2Fi2.hdslb.com%2Fbfs%2Farchive%2F1b6e96735930655e2c4ba1df2a5c4c9846c8aef7.jpg";
                                ...
                                if (!TextUtils.isEmpty(resBean.getState())) {
                                    ...
                                    } else if (resBean.getState().equals("9")) {
                                        tv_state.setText("已销号");
                                    }
                                }
                            }
