...
public class FullMarkTaskFragment extends BaseFragment {
     ...
     * 38
     */
    public static FullMarkTaskFragment newInstance(String str, int pos) {
        FullMarkTaskFragment fragment = new FullMarkTaskFragment();
