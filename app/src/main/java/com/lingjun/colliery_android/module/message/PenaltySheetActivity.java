 ...
 * 注释: 处罚单
 */
public class PenaltySheetActivity extends BaseActivity {
    ...
    private RecyclerView rv_img_list, rv_img_list1;//图片
    ...
    protected int getResourcesId() {
        return R.layout.activity_penalty_sheet;
    }
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        tv_jingjichufa = findViewById(R.id.tv_jingjichufa);
        tv_xuexi = findViewById(R.id.tv_xuexi);
        tv_time = findViewById(R.id.tv_time);
        tv_auditor = findViewById(R.id.tv_auditor);
        tv_bianzhi = findViewById(R.id.tv_bianzhi);
        tv_content = findViewById(R.id.tv_content);
        tv_shensu = findViewById(R.id.tv_shensu);
        rv_img_list = findViewById(R.id.rv_img_list);
        rv_img_list1 = findViewById(R.id.rv_img_list1);
        btn_complete = findViewById(R.id.btn_complete);
        Intent getIntent = getIntent();
        taskId = getIntent.getStringExtra("task_id");
        message_type = getIntent.getStringExtra("message_type");
        if (message_type.equals("132")) {
        ...
        btn_complete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(responsibleUserPhone)) {
                    ToastUtils.showToast(PenaltySheetActivity.this, "此责任人没有预留电话");
                } else {
                    Intent dialIntent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + responsibleUserPhone));
    ...
    private void RefreshView() {
        ...
        mRetrofit.JsonToColliery(BaseLinkList.Base_Url, hashMap, new BaseSubscriber() {
            ...
            public void onSuccess(JSONObject jsonObject) {
                ...
                DisobeyInfoBean.DataBean dataBean = disobeyInfoBean.getData();
                responsibleUserPhone = dataBean.getResponsibleUserPhone();
                //三违单信息
...
//                    }
                ...
                //填充图片
                RecyclerViewUtils.initGridNoSc(PenaltySheetActivity.this, rv_img_list, R.layout.item_image, disobeytaskdoc, new OnGlobalListener() {
                    @Override
                    public <T> void logic(BaseViewHolder helper, List<T> mData, T item, BaseQuickAdapter mAdapter) {
                        ...
                        if (!TextUtils.isEmpty(disobeytaskdocBean.getUrl()) && !TextUtils.isEmpty(disobeyInfoBean.getData().getUrl())) {
                            Glide.with(PenaltySheetActivity.this).load(BaseLinkList.Base_Url + "?" + BaseLinkList.apiurl + "=" + BaseLinkList.coal_mine + disobeytaskdocBean.getUrl()).into(iv_icon);
                        }
                    ...
                    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                        ...
                        ImagePreview
                                ...
                                .setContext(PenaltySheetActivity.this)
...
//                                          .setImageInfoList(imageInfoList)
                ...
                //填充图片
                RecyclerViewUtils.initLiner(PenaltySheetActivity.this, rv_img_list1, R.layout.item_jiuwei_unsafe, taskclauselist, new OnGlobalListener() {
                    @Override
                    public <T> void logic(BaseViewHolder helper, List<T> mData, T item, BaseQuickAdapter mAdapter) {
